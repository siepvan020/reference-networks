...
# Define log file
# log_file <- "/div/pythagoras/u1/siepv/siep/Analysis/logfile_parallel.txt"
...
progress_file <- "/div/pythagoras/u1/siepv/siep/Analysis/v2_parallel/progress.log"
...
run_scorpion <- function(object, cell_types, output_file) {
    ...
    foreach(
        ...
        gex_cell <- as(cell_subset@assays$decontXcounts@counts, "dgCMatrix")
